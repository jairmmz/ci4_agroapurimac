                            ...
                            <ul id="app1" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                                ...
                                <li class=" sidebar-layout">
                                    <a href="<?php echo base_url("") ?>/admin/categorias" class="svg-icon">
                                        <i class="fa fa-list-ul"></i><span class="">Categorias de Productos</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                                ...
                                <li class="nav-item nav-icon dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        <li class="dropdown-item d-flex svg-icon">
                                            ...
                                            <a href="../app/user-profile.html">Mi Perfil</a>
                                        </li>
                                        <li class="dropdown-item d-flex svg-icon">
                                            ...
                                            <a href="../app/user-profile-edit.html">Editar Perfil</a>
                                        </li>
                                        <li class="dropdown-item d-flex svg-icon">
                                            ...
                                            <a href="../app/user-account-setting.html">Configuraciones de la cuenta</a>
                                        </li>
                                        <li class="dropdown-item d-flex svg-icon">
                                            ...
                                            <a href="../app/user-privacy-setting.html">Ajustes de Privacidad</a>
                                        </li>
