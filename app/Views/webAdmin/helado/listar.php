    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="header-title">
                <h4 class="card-title" _msthash="2343094" _msttexthash="60021">Lista de Productos</h4>
            </div>
        </div>
        <!---->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="card" style="border: solid 1px #8f9fbc;">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title text-center">Agregar nuevo Producto</h4>
                                    <form action="<?php echo base_url("admin/helados/insertar") ?>" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" REQUIRED name="nombre" class="form-control" id="exampleInputText1" value="" placeholder="Ingrese el nombre del producto">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputText1">Precio S/.</label>
                                            <input type="text" REQUIRED name="precio" class="form-control" id="exampleInputText1" value="" placeholder="Ingrese el precio.">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputText1">Stock</label>
                                            <input type="number" REQUIRED name="stock" class="form-control" id="exampleInputText1" value="" placeholder="Ingrese el stock del producto">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="descripcion" id="exampleFormControlTextarea1" rows="3" placeholder="Ingrese la descripcion del producto."></textarea>
                                        </div>
                                        <div class="form-group">
